...
namespace WindingMode.Graficos
{
    internal class GraficoEstrella : IDrawable
    {
        public void Draw(ICanvas canvas, RectF dirtyRect)
        {
            ...
            canvas.FillPath(path, Microsoft.Maui.Graphics.WindingMode.EvenOdd); // Overload automatically uses a NonZero winding mode
